...
public class Uniform_TC038 {
			...
			public void validLoginTest() throws InterruptedException {
				...
				Thread.sleep(1000);
				uniformadmindashboardPOM.addNew();
				uniformadmindashboardPOM.sendipName("1Test");
				uniformadmindashboardPOM.sendcatDesc("1Test");
				uniformadmindashboardPOM.sendtagName("1Test");
				uniformadmindashboardPOM.sendtagDesc("1Test");
